 ...
 * calibrate.c
 *
 * @brief This routine automatically calibrates the BladeRF device for the input frequency of operation.
...
/**
 * @brief BladeRF device structure.
 */
typedef struct blade_dev{
